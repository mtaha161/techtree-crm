    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white rounded-2xl shadow-lg p-10 w-full max-w-md flex flex-col items-center gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 mt-1 text-sm">Sign in to access your pipeline</p>
        </div>
        ...
        >
          {loading ? (
            <>
              {/* Spinner */}
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" style={{ animation: 'spin .8s linear infinite', flexShrink: 0 }}>
        ...
        <p className="text-xs text-gray-400 text-center">
          Access is restricted to TechTree team members.<br />New accounts require admin approval.
        </p>
      </div>
